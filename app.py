...
def generate_insights(company_name, product_name,company_url, company_competitors):
    ...
    messages = [
        SystemMessage(f"You are a professional sales assistant with deep expertise in market research. Using publicly available web data, provide concise and structured insights "),
        ...
        1. Industry and customer trends {product_name}
